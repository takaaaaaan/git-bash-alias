...
# reelsbio server
alias recl='ssh -i "Admin.pem" ubuntu@ec2-43-200-235-98.ap-northeast-2.compute.amazonaws.com'
alias read='ssh -i "Admin.pem" ubuntu@ec2-13-124-5-234.ap-northeast-2.compute.amazonaws.com'
